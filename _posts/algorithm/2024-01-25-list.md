...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/simpleList.png">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/doublyList.png">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/circular.png">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/seqAccess.jpeg">
</div>
...
배열이 가득 찬 경우 기존 배열을 더 크기가 큰 배열로 복사하는 과정인 `resize()` 연산을 해야한다. 
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/arrayInsert.jpeg">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/arrayDelete.jpeg">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/linkedListInsert.png">
</div>
...
<div style="text-align: center;">
    <img src = "/image/posts/algorithm/list/linkedListDelete.png">
</div>
...
// 2. 정적 할당(메모리 풀) 방식
constexpr size_t MAX_NODE = 10000; //메모리 풀 사이즈는 적절하게 선택
